  ...
  return (
    <div className="border border-gray-200 lg:border-none bg-white lg:shadow-sidebar rounded-lg lg:rounded-3xl p-6 lg:p-10 mb-6">
      <div className="flex items-center justify-between mb-4">
        <h4 className="textLg text-text1">نتیجه آزمون {responseData?.poll?.title}</h4>
        <Link href={`/quiz/${singelQuiz}`} className="textSmm text-text1 mb-4 cursor-pointer">
          بازگشت
