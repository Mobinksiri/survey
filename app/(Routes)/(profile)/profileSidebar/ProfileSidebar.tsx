...
const ProfileSidebar = () => {
   ...
   return (
      <>
         {/* avatar */}
         <div className="w-11/12 lg:w-auto justify-around flex mx-auto lg:mx-0 flex-row lg:flex-col">
          ...
          <h5 className="mx-auto w-fit textSm text-text3">{userData?.email ?? ''}</h5>
            ...
            <div className="hidden lg:block mb-4">
               ...
               {userData?.isAdmin && (
                  <SidebarItem title="گزارش گیری" href="report_history" icon="bug" />
               )}
               {userData?.isAdmin && (
                  <SidebarItem title="خبرنامه" href="news_letter" icon="newspaper" />
               )}
               {userData?.adminType == 2 && (
