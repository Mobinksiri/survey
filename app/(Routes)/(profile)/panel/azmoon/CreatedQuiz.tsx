   ...
   return (
      <div className="col-span-1 flex items-center justify-between px-4 py-3 last:mb-0 border border-[#D4D4D4] rounded-md">
         <div className="flex items-center">
            <Image width={35} height={35} src={foundedIcon?.icon} className="ml-4" alt="" />
...
const CreatedQuiz = ({ array, removePoll }: { array: any[]; removePoll: any }) => {
   return (
      <>
         <p className="textMd text-text1 mb-6 font-extrabold">آزمون های اضافه شده</p>
         ...
         {array?.length ? null : <p className="textSm font-bold text-text1">آزمونی ثبت نشده است</p>}
      </>
   );
};
