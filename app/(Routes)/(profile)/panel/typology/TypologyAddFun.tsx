...
const TypologyAddFun = () => {
  ...
  const [audio, audioSet] = useState<any>(null);
  ...
  const handleAddPost = async () => {
    if (
      ...
      (selectedFamousPeopleCategory?.value === 1 && !audio)
    ) {
  ...
  return (
    <div className="my-6">
      <StepBar array={[{ title: 'تایپ شناسی' }, { title: 'اضافه کردن سرگرمی' }]} />
          ...
          <div className="border border-gray2 rounded-lg p-6">
            {image ? null : (
              <>
                ...
                {selectedFamousPeopleCategory?.value === 1 && (
                  <div className="mb-6">
                    <p className="textSmm font-normal text-text3 mb-2 w-full">فایل موسیقی</p>
                    <input
