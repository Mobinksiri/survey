  ...
  return (
    <Modal isOpen={isOpen} onClick={clearFunction}>
      <div className="p-6 bg-white w-[calc(100vw-32px)] md:sm:w-[calc(100vw-50px)] lg:w-[760px] rounded-2xl">
        <h4 className="textMd text-text1 mb-6 pb-6 border-b border-b-gray2">افزودن مشخصات همکار</h4>
        {!image && !result ? (
          <div className="mb-8">
            ...
            <p className="textSmm text-red">سایز 90 * 90</p>
          </div>
        ) : (
          <></>
        )}
        ...
        <div className="flex flex-col items-center gap-4 my-6">
          <CustomInput label="نام" state={title} setState={titleSet} />
          <CustomInput type="textarea" label="توضیحات" state={date} setState={dateSet} />
        </div>
...
const JournalAddArthurSlide = () => {
  ...
  return (
    <div className="my-6">
      ...
      <StepBar array={[{ title: 'دیگر صفحات' }, { title: 'همکاران ما' }]} />
      <div className="lg:bg-white lg:shadow-sidebar lg:rounded-3xl lg:p-6">
        <div className="my-6">
          <div className="mb-6">
            <p className={`textSmm font-normal text-text3 mb-2 w-full`}>توضیحات همکاران ما</p>
            <RichTextEditor setState={descriptionSet} defaultValue={description} />
          </div>
          <CustomInput
            label="عنوان همکاران ما"
            state={title}
            setState={titleSet}
            parentClassName="mb-6"
          />
          <div className="border border-gray-200 p-4 rounded-lg">
            <p className={`textSmm font-normal text-text3 mb-4 w-full`}>همکاران ما</p>
            <div className="">
              {activityList?.length
