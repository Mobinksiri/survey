...
const AddProduct = () => {
  ...
  return (
    <>
      <StepBar array={[{ title: 'فروشگاه' }, { title: 'جزوات' }]} />
      <div className="border lg:border-none border-gray-200 p-4 lg:bg-white lg:shadow-sidebar rounded-lg lg:rounded-3xl mb-5 lg:p-6">
        <div className=" grid grid-cols-2 gap-4 mb-10">
          <div>
            <CustomInput setState={setName} state={name} label="عنوان جزوه" />
          </div>
          <div>
            <CustomInput setState={setAuthor} state={author} label="نویسنده" />
          </div>
