...
//     return apiCall({
//       url: `/api/verifycommentOnPoll/${item?.id}`,
//       method: 'put',
//       data: {
//         status,
//       },
...
//           <p className="textSm text-text1 font-extrabold ml-2">آزمون:</p>
...
//             <p className="textSm text-text3 font-normal">{item?.user?.name} </p>
//           </div>
//           <div className="flex items-center mb-4">
...
//           <p className="textSm text-text3 font-normal">{item?.content}</p>
//         </div>
//       </div>
...
//   return (
//     <div>
//       <StepBar array={[{ title: 'آزمون' }, { title: 'مدیریت کامنت ها' }]} />
//       <div className="bg-white lg:shadow-sidebar rounded-3xl lg:p-8 mb-6">
//         <div className="flex flex-col lg:flex-row items-center justify-between mb-8">
//           <h4 className="textXl text-text1 mb-4 lg:mb-0">مدیریت کامنت ها</h4>
