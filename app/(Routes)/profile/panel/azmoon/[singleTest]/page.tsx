  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <i
            className={`fa fa-regular text-text1 textSmm fa-${
              quizTypes[type - 1]?.icon
            }`}
          />
...
const Page = () => {
  ...
  const { data: selectedQuestionApi, refetch: refetchSelectedQuestion } =
    useApiCall<any>({
  ...
  const foundedItem = quizTypes?.find(
    (item) => item?.type === Number(searchParams?.get("type"))
  );
  ...
  const checkDuplicate = (value: string, id: string) => {
    ...
    const duplicateIds = multiQuestion
      .filter(
        (item) => item.question?.trim() === trimmedValue && item.id !== id
      )
      .map((item) => item.id);
    return duplicateIds;
  };

  const changeQuestionInput = (
  ...
  const [openQuestionOptionsInMobile, openQuestionOptionsInMobileSet] =
    useState(false);
  ...
  if (!singlePoll?.data) {
    return (
      <p className="textSm font-bold text-text1">آزمون مورد نظر پیدا نشد.</p>
    );
  }
      ...
      <div className="w-full rounded-lg bg-white border border-gray-100">
            ...
            <div className="h-screen lg:h-[calc(100vh-75px)] border-l border-l-gray-100 flex flex-col justify-between col-span-12 lg:col-span-3">
              ...
              <div className="flex items-center px-6 py-4 border-b border-b-gray-100">
                ...
                >
                  ...
                  <h3 className="textSm font-bold text-text1">
                    {foundedItem?.label}
                  </h3>
                </div>
              </div>
              ...
              <div className="px-5 py-4 h-[calc(100%-132px)] overflow-auto">
                ...
                <div className="pt-3">
                  <div className="flex items-center justify-between">
                    ...
                    <Toggle
                      state={requiredQuestion}
                      setState={requiredQuestionSet}
                    />
                  </div>
                </div>
              </div>
              ...
              <div className={`w-full h-full flex items-center`}>
                <div className="w-full">
                  ...
                  {descriptionToggle && description ? (
                    <p className="textSmm font-normal text-text3 mb-4">
                      {description}
                    </p>
                  ) : null}
                  ...
                  {foundedItem?.type === 3 ? (
                    <div className="flex items-center gap-2">
                      <div className="flex items-center w-[380px] h-[40px] rounded-xl overflow-hidden">
                        {Array.from(Array(rangeValue).keys())?.map(
                          (item, index) => {
        ...
        <div className="flex items-center p-4 border-b border-b-gray-100 justify-between w-full">
          <div className="flex items-center">
            ...
            <div className="flex items-center">
              <p className="textSmm text-text3 font-normal rounded-lg">
                آزمون های من
              </p>
        ...
        <div className="grid grid-cols-12 gap-4">
            ...
            {quizTypes?.map((item, index) => {
              return (
                ...
                >
                  ...
                  >
                    <i
                      className={`fa fa-regular text-text1 fa-${item?.icon}`}
                    />
                  </div>
          ...
          <div className="col-span-12 lg:col-span-9 p-4">
            {questionsList && questionsList?.[0] ? (
              ...
              <p className="textSmm font-normal text-text1">
                سوالی اضافه نکردید.
              </p>
            )}
          </div>
