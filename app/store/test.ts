      ...
      switch (type) {
        ...
        case 'ADD_QUESTION':
          ...
          if (questionType == 1 || questionType == 2) {
            state.answers = [
              ...state.answers,
              { questionId: id, score: null, choiceId, description: null },
            ];
          }
          if (questionType == 3 || questionType == 4) {
            state.answers = [
              ...state.answers,
              { questionId: id, score: choiceId, choiceId: null, description: null },
            ];
          }
          if (questionType == 5) {
            if (!choiceId) {
              ...
              state.answers = [
                ...state.answers,
                { questionId: id, score: null, choiceId: null, description: choiceId },
              ];
            }
          }
          break;
