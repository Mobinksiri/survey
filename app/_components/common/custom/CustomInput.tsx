    ...
    return (
      <div className={`w-fit h-fit ${parentClassName}`}>
        ...
        <div className="relative flex items-center z-[1] bg-gray-200 rounded-lg px-3 py-2">
          ...
          <input
            accept=".png, .jpg"
            className={`textSmm z-[10] cursor-pointer text-text3 absolute top-0 left-0 opacity-0 bottom-0 right-0 rounded-2xl border border-[#D6D6D6] outline-none w-full h-full ${inputClassName}`}
  ...
  if (type == 'textarea') {
    return (
      <div className={`w-full h-fit ${parentClassName}`}>
        ...
        <textarea
          className={`textSmm text-text3 rounded-2xl border border-[#D6D6D6] outline-none focus:border-[#959595] px-4 py-2 w-full placeholder:text-[13px] placeholder:opacity-80 transition-all min-h-[40px] h-20 max-h-36 resize-none ${inputClassName}`}
          value={state ?? ''}
      ...
      <>
        <Modal isOpen={dateModal} onClick={() => dateModalSet(false)}>
          ...
          >
            <div className="flex pb-4 pl-4 pr-4 pt-2">
              <CustomButton variant="primary" onClick={submitDatePicker} className="w-full mr-4">
                تایید
              </CustomButton>
        ...
        <div className={`w-full ${parentClassName}`}>
          ...
          <div className="relative">
            <input
              className={`textSmm text-text3 rounded-2xl border border-[#D6D6D6] outline-none focus:border-[#959595] h-10 px-4 py-2 transition-all w-full placeholder:text-[13px] placeholder:opacity-80 ${inputClassName}`}
              value={state ?? ''}
